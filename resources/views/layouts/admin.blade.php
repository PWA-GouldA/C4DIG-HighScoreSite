...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index">
            ...
            <div class="sidebar-brand-text mx-3">HiSS</div>
        </a>
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#userRoles" aria-expanded="true"
               aria-controls="userRoles">
                <i class="fas fa-fw fa-users"></i>
                <span>Users</span>
            </a>
            <div id="userRoles" class="collapse" aria-labelledby="userRoles" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <h6 class="collapse-header">Users &amp; Roles</h6>
        ...
        <footer class="sticky-footer bg-white">
            <div class="container my-auto">
                <div class="copyright text-center my-auto">
                    <span>HiSS | Copyright &copy; TAFE Open Source, 2019</span>
                </div>
            </div>
        </footer>
        <!-- End of Footer -->
